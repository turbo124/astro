---
title: What Freelancers Need to Know About Bitcoin
description: What on earth is Bitcoin? This is the initial reaction of many people when first learning of the virtual currency as a viable payment method for freelance se...
...
“The blockchain is the vertebrae of the protocol and the glue that holds the network together. It is simply a vast, distributed public ledger of account. It keeps track of every transaction ever made in the network, and all transactions are timestamped and verified by network miners.” ([Bitcoin FAQs](https://www.bitcoin.com/faq))
...
At Invoice Ninja we’ve partnered with a few trusted exchanges including Coinbase and Bitpay (see: [Our integration partners](https://www.invoiceninja.com/partners/)) which can accept Bitcoin payments and integrate these with your Invoice Ninja invoicing activity.
...
Most importantly, as a freelancer, [you can also invoice and get paid in the cryptocurrency.](https://www.invoiceninja.com/freelancers-accept-bitcoin/)

### In next week’s article we’ll explore how freelancers and small business owners can accept Bitcoin payments from their clients.
